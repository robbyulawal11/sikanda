...
<link href="{{ asset('assets/css/index.css') }}" rel="stylesheet" />
  ...
  <section id="create_article">
      <div class="container">
          <form class="d-flex flex-column" method="post" action="{{ route('article.store') }}" enctype="multipart/form-data" onsubmit="return submitForm()">
              @csrf
              @method('POST')
              <div class="mb-3">
                  <label for="title" class="form-label">Judul</label>
                  <input type="text" name="title" id="title" placeholder="Judul Artikel" class="form-control" required>
                  @if ($errors->has('title'))
              ...
              <div class="mb-3">
                  ...
                  <input type="text" name="author" id="author" placeholder="Nama Penulis Artikel" class="form-control" required>
