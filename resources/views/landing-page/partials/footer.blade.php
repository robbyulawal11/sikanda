<style>
    ...
    .pattern-background::before {
        ...
        width: 100%;
        height: 100%;
        background: url('{{ asset('assets/img/pattern_small.jpg') }}') repeat;
        opacity: 0.15;
        /* Opasitas gambar */
        z-index: 1;
    ...
    .pattern-background>* {
        position: relative;
        z-index: 2;
        /* Pastikan konten berada di atas gambar latar */
    }
</style>
        ...
        <div class="row g-5">
            ...
            <div class="col-lg-3 col-md-6">
                ...
                <div class="d-flex flex-column justify-content-start">
                    ...
                    <a class="text-body mb-2" href="visimisi"><i class="bi bi-arrow-right text-primary me-2"></i>Visi
                        Misi</a>
