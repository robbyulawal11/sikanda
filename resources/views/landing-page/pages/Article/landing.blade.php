    ...
    <div class="container">
        ...
        <div class="row g-5">
            @foreach($articleslatesttwo as $atwo)
                <div class="col-lg-6">
                    <div class="blog-item">
                        <div class="row g-0 bg-light overflow-hidden" style="height: 100%;">
                            <div class="col-12 col-sm-5 h-100 d-flex justify-content-center align-items-center">
                                <img class="img-fluid mt-4 ml-4" src="{{ asset('/images/articles/' . $atwo->image) }}" alt="{{ $atwo->title }}" style="max-width: 100%; max-height: 100%; object-fit: cover;">
                            </div>
                            <div class="col-12 col-sm-7 h-100 d-flex flex-column justify-content-start">
                                <div class="p-4">
                                    <div class="d-flex mb-3">
                                        <small><i class="bi bi-calendar-date me-2"></i>{{ $atwo->updated_at->format('d M, Y') }}</small>
                                    </div>
                            ...
                            <div class="col-12">
                                <div class="mt-1 ml-4">
                                    ...
                                    <a class="text-primary text-uppercase" href="{{ route('landing.article.show' , ['id' => $atwo->id]) }}">Read More<i class="bi bi-chevron-right"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
